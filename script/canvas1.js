...
var ve = sirina*0.01;
var ha = visina*0.7;
var pom = sirina/3.2-sirina/4;
var iks2 = (n-1)*razmakX+sirina/3.2+pom+sirina*0.1;
...
while(i<m){
	...
	while(j<n){
		var tacka = {};
		krug(j*razmakX+sirina/3.2,i*razmakY+visina/20, radius);
		tacka.x = j*razmakX+sirina/3.2;
		tacka.y = i*razmakY+visina/20;
		dots.push(tacka);
		j++;
	}
	i++;
